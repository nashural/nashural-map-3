  ...
  useLayoutEffect(() => {
    ...
    (async () => {
      ...
      dispatch(
        toggleInfo({
          show: true,
          humanTime: (newRoute.getHumanTime() as string).replace(
            /&#160;/g,
            " "
          ),
          humanJamsTime: (newRoute.getHumanJamsTime() as string).replace(
            /&#160;/g,
            ""
          ),
          humanLength: (newRoute.getHumanLength() as string).replace(
            /&#160;/g,
            " "
          ),
