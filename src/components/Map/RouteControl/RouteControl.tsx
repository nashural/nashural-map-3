...
import { RouteControlProps, ReferencePoint } from './typings.d'
...
export const RouteControl: FC<RouteControlProps> = () => {
  ...
  const handleSelect = useCallback(async (e: any) => {
    ...
    const referencePoints: ReferencePoint[] = target.options.get('referencePoints')
    target.deselect()
